...
# temp3 = pd.DataFrame()
# for i in range(21):
# 	temp3 = summer3.iloc[i].resample('1H').sum()
...
temp4 = pd.DataFrame()
for i in range(21):
	temp4 = summer4.iloc[i].resample('1H').sum()
	temp4 /= 3600
...
temp5 = pd.DataFrame()
for i in range(21):
	temp5 = summer5.iloc[i].resample('1H').sum()
	temp5 /= 3600
...
office1 = data1+data4+data5
# print(office1)
print(office1.shape)
indexday=pd.date_range('20120726','20120815235959',freq='1H')
office1 = pd.DataFrame(office1,index=indexday)
office1.plot()
plt.title('House 1 4 5')

office2 = data2
# print(office2)
print(office2.shape)
office2 = pd.DataFrame(office2,index=indexday)
office2.plot()
plt.title('House 2 ')
plt.show()